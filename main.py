...
from Semantic_Segment_Anything.scripts.pipeline import semantic_segment_anything_inference, eval_pipeline, img_load
...
#     parser.add_argument('--dataset', type=str, default='ade20k', choices=['ade20k', 'cityscapes', 'foggy_driving'],
...
#             filenames += [os.path.join(sub_folder, fn_.replace('.png', '')) for fn_ in
#                           os.listdir(args.data_dir + sub_folder) if '.png' in fn_]
